...
def test_return_user(test_user):
    ...
    assert response.json()['username'] == 'Sky_test'
    assert response.json()['email'] == 'flamesky_TEST@gmail.com'
    assert response.json()['first_name'] == 'Test-Ning'
    assert response.json()['last_name'] == 'L'
